...
import update_data_detection as update_data_detection 
import src.scrape.scrape_doc
    ...
    if page_key == "data":
        ...
        if master_df.empty:
            ...
            if st.button("Run scraping", use_container_width=True):
                itns_with_no_data_on_Expeditors = src.scrape.scrape_doc.run_scrape(itns_need_scraping)
